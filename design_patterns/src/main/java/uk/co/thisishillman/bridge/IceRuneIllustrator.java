 ...
 * @version 1.0
 */
public class IceRuneIllustrator implements Illustrator {

    /**
     * Draw the ice rune at the input size on the input page
     * 
    ...
    public void drawRune(String size, int page) {
        System.out.println("Drawing a " + size + " Ice Rune on page " + page + ".");
    }
