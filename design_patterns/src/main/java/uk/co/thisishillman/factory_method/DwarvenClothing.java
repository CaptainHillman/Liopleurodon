...
/**
 * Dwarven clothing class
 * 
 * @author Michael Hillman
 * @version 1.0
 */
public class DwarvenClothing implements Clothing {
    ...
    /**
     * Initialises a new Dwarven Clothing instance with the input clothing type
     * 
     * @param type ClothingType
     */
    protected DwarvenClothing(ClothingType type) {
       this.type = type; 
    }
