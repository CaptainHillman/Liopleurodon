...
/**
 * Elvish tailor implementing the Tailor interface
 * 
 * @author Michael Hillman
 * @version 1.0
 */
public class ElvishTailor implements Tailor {

    /**
     * Makes (then returns) a new Elvish Clothing instance
     * 
    ...
    public Clothing makeClothes(ClothingType type) {
        return new ElvishClothing(type);
    }
