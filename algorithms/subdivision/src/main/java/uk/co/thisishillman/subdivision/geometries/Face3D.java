...
public class Face3D {
    ...
    /**
     * Returns a set of all Vertex3D objects that comprise this face. Note: these are return in order of edge construction,
    ...
    /**
     * Performs equality check between this instance & input object. Returns false if the input object is null or not an
     * instance of Face3D. Returns true if every edge in this instance equals the corresponding edge in the input face.
     *
