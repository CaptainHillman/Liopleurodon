...
/**
 * This class contains utility methods used in the <code>RootThree</code> subdivision algorithm. Whilst the RootThree class
 * contains the main logic, this class contains geometric traversal, numerical & search functions.
 *
 * @author M Hillman
...
public class RootThreeUtilities {
    ...
    /**
     * Given an input vertex, this method return a set of all the vertices in the polyhedron that ring the input vertex.
     *
    ...
    /**
     * Given an edge & it's containing face, this method will search for the only other face that wings that edge and returns
     * it's midpoint.
     *
