...
public class Vertex3D {
    ...
    /**
     * Two Vertex3D objects are evaluated as equal if all float components evaluate as equals. Returns false if the input
     * object is null or not an instance of Vertex3D.
     *
