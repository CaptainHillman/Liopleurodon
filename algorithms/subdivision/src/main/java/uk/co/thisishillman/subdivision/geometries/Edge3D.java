...
public class Edge3D {
    ...
    /**
     * Returns true if the input Vertex3D object equals this edge's starting or ending vertex.
     *
    ...
    /**
     * Calculates & returns a Vertex3D representing the midpoint of this Edge3D instance.
     *
    ...
    /**
     * Performs equality check, false if input object is null or not an instance of an Edge3D object. Returns true if this
     * instance & the input Edge3D object's start & end vertices match numerically.
     *
    ...
    /**
     * Returns a textual representation of this Edge3D object, defined by it's comprising start & end Vertex3D objects.
     *
