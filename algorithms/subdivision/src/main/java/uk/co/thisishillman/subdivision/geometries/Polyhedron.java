...
public class Polyhedron {
    ...
    /**
     * Returns an hash set of all Edge3D objects that comprise this polyhedron. Note: these are return in order of edge
     * construction, without any duplicates.
     *
    ...
    /**
     * Returns an set of all Vertex3D objects that comprise this polyhedron. Note: these are return in order of edge
     * construction, without any duplicates.
     *
