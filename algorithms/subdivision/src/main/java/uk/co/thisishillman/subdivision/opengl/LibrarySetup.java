...
public class LibrarySetup {
    ...
    /**
     * Determines Operating System & hardware architecture to set the Java library path to the appropriate folder. Primarily
     * used to point towards the correct JOGL & GlueGen native libraries.
     */
